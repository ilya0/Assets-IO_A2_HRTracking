...
var ManufacturerLoginPage = /** @class */ (function () {
    ...
    ManufacturerLoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-manufacturer-login',template:/*ion-inline-start:"/Users/GI68L7/code/InnovationDays/SmartErp/SmartERPInnovationDay/TransactionVisualizer/src/pages/manufacturer-login/manufacturer-login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n<ion-content class="login-content " padding>\n<ion-col col-12="" class="login-form">\n  <ion-row class="logo-row">\n    \n    <ion-col col-12="">\n      <h1 class="loginheading">Manufacturer Login</h1>\n    </ion-col>\n    \n  </ion-row>\n  <div class="login-box">\n    <form (ngSubmit)="login()" #registerForm="ngForm">\n      <ion-row>\n        <ion-col>\n          <ion-list inset>\n            \n            <ion-item>\n              <ion-input type="text" placeholder="Email" name="email" [(ngModel)]="registerCredentials.email" required></ion-input>\n            </ion-item>\n            \n            <ion-item>\n              <ion-input type="password" placeholder="Password" name="password" [(ngModel)]="registerCredentials.password" required></ion-input>\n            </ion-item>\n            \n          </ion-list>\n        </ion-col>\n      </ion-row>\n      \n      <ion-row>\n        <ion-col class="signup-col">\n          <button ion-button class="submit-btn" full type="submit" [disabled]="!registerForm.form.valid">Login</button>\n         \n        </ion-col>\n      </ion-row>\n      \n    </form>\n  </div>\n  </ion-col>\n</ion-content>\n'/*ion-inline-end:"/Users/GI68L7/code/InnovationDays/SmartErp/SmartERPInnovationDay/TransactionVisualizer/src/pages/manufacturer-login/manufacturer-login.html"*/,
        }),
